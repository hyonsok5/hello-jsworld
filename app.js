...
function newsFeed(){
  ...
  template = template.replace('{{__next_page__}}',store.currentPage+1 < newsFeedLen+1?store.currentPage+1:store.currentPage);
...
function newsDetail(){
  ...
  container.innerHTML = `
    ...
    <div>
      <a href='#/page/${store.currentPage}'>to List Page</a>
    </div> 
  `; 
